...
create table Booking (LineID varchar(40) references Booker(LineID) not null, OfferID varchar(8) not null, Adults smallint, Children smallint, Toddlers smallint, TourFee real, AmountPaid real, SpecialRequest varchar(500), Cancelled boolean default false, primary key (LineID,OfferID), foreign key (TourID, OfferID) references TourOffering(TourID, OfferID));
